...
function start () {
  io = require('socket.io')({
    ...
    // aquestes opcions afecten el socket.io client servit
    // compatibilitat amb clients Nightscout (Engine.IO v3)
    allowEIO3: true,

    // optimitzacions del client
    ...
    // PRIORITZEM websocket però mantenim polling per compatibilitat
    transports: ['websocket', 'polling'],

    // intervals saludables per Heroku (menys reconexions i menys logs)
    pingInterval: 25000,
    pingTimeout:  20000
  });
